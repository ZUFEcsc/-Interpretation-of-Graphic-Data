...
public class DrawHistogramFalse extends PApplet{
	...
	public static boolean judgeDraw = false;
	...
	/**
	 * @return the falseconst
	 */
	public int getFalseconst() {
		return falseconst;
	}

	/**
	 * @param falseconst the falseconst to set
	 */
	public void setFalseconst(int falseconst) {
	...
	/**
	 * @param nodesFlag the nodesFlag to set
	 */
	public void setNodesFlag(int nodesFlag) {
